          ...
          <Row>
            {token === "" ? (
              ...
              <DataTable
                ...
                columns={[
                  ...
                  { data: "cliente", title: t("customer") },
                  {
                    ...
                    render: (data, type, row) => {
                      return moment(`${row.fecha}`).format(
                  ...
                  { data: "estado_factura", title: t("status") },
                  {
                    title: t("action"),
                    data: null,
                    orderable: false,
                ...
                slots={{
                  9: (cellData, rowData) => this.ActionButtons(rowData),
                }}
                options={{
                  language: {
          ...
          >
            ...
            <Modal.Body>
              ...
              <Row className="m-2">
                ...
                {/* Estado factura */}
                <Col sm="12" xl="6">
                  <label className="txt-darkblue">{t("invoice_status")}</label>
                  <Form.Group>
                    <Form.Select
                ...
                <Col sm="12" xl="4">
                  ...
                  {this.state.processing ? (
                    ...
                    <Select
                      ...
                      onChange={(value) =>
                        this.setState({
                          income: { ...this.state.income, clientes_id: value.id },
                        })
                      }
                        ...
                        {lines.length > 0 && (
                          <tfoot>
                            <tr className="table-info fw-bold">
                              ...
                              <td>{income.subtotal.toFixed(2)}</td>
                              <td>{income.descuento.toFixed(2)}</td>
                              <td>{income.impuesto.toFixed(2)}</td>
            ...
            <Modal.Footer>
              ...
              {processing ? (
                ...
                !isView && (
                  <Button variant="primary" onClick={this.saveIncome}>
                    {t("save")}
                  </Button>
                )
              )}
