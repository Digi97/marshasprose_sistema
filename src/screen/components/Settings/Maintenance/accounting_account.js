        ...
        <Row>
              ...
              <thead>
                <tr>
                  ...
                  <th>{t("code")}</th>
                  <th>{t("name")}</th>
                  <th>{t("type_accounting_account")}</th>
                  <th>{t("active")}</th>
                  <th>{t("inicial_amount")}</th>
                  <th>{t("current_amount")}</th>
          ...
          <Modal.Body>
                ...
                <Col sm="12" xl="12">
                      <label className="txt-darkblue">{t("type_accounting_account")}</label>
                       <Form.Group>
                            <Form.Control
                                placeholder={t("type_accounting_account")}
                                type="text"
                                onChange={this.getInputData}
                                name="tipo_cuenta_contable_id"
                                required
                                maxLength={200}
                                />
                       </Form.Group>
